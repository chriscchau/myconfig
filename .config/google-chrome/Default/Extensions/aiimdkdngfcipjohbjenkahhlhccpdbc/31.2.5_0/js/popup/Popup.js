(function(){
	...
	var Popup = function(){
		...
		var HINTS = {			
					...
					"youtube-dark-mode": {
						label: "Youtube Dark Mode",
						url: "https://chrome.google.com/webstore/detail/youtube-dark-mode/jlhgcomgldfapimdboelilfcipigkgik",
						icon: "/images/youtube-dark-mode-icon.png",	
						flag: true,
						set: "popup.display_hints_1",
						pref: true,
					}
